...
public class Log {
    ...
    public Log(String string, String str14, HashMap<String, Adventure> a2) {
        ...
        for (int j = 0; j < Integer.parseInt(strings2[1]); ++j) {
            ...
            //adventure.setOldHitPoint(adventure.getHitPoint()); 有问题得在开头设置……
    ...
    public void notice() {
        for (String temp : advNames) {
            Adventure a1 = adv.get(temp);
            if (a1.getHitPoint() <= (a1.getOldHitPoint() / 2)) {
                a1.notifyFollowers(a1.getOldHitPoint() - a1.getHitPoint());
            }
        }
    }
